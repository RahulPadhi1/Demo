...
Adding a power up boost every 100 points to give a jump boost

**********Bugs
Fixing some glitches with the platforms where your character doesnt land on the platform and dies 
Making it always possible to jump onto another platform

**********Gameplay fixes
Adding an end screen after someone dies
Making sure the platoforms are less random so that they are never right mext to each other 
Pausing screen when you hit the monsters so you know how you hit it 

**********Features
Character jump boosts 
